...
int main(int argc, char *argv[])
{
    ...
    // relative paths (PBG3 archives, bgm/, fonts, etc.) resolve correctly
    // regardless of where the game is launched from (Finder, terminal, .app bundle).
...
restart:
    ...
    while (true)
    {
        ...
        while (SDL_PollEvent(&e))
        {
            ...
            {
                g_GameWindowWidthReal = e.window.data1;
                g_GameWindowHeightReal = e.window.data2;
